...
uses
  ...
  FMX.Objects, FMX.Controls.Presentation, FMX.StdCtrls, Data.DB, Data.Win.ADODB,blog_3, blog_2;
...
procedure TBlog1.Button1Click(Sender: TObject);
begin
Blog3.Show;
end;

procedure TBlog1.Button2Click(Sender: TObject);
begin
Form2.Show;
end;

procedure TBlog1.Button3Click(Sender: TObject);
begin
Blog3.ShowModal;
end;

procedure TBlog1.Circle100MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
ADOQuery1.SQL.Add('select * ');
ADOQuery1.SQL.Add('from Blog_1');
ADOQuery1.SQL.Add('where N = "'+IntToStr(25)+'"');
ADOQuery1.Open;
if Circle100.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle101MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle101.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle102MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(26)+'"');
ADOQuery1.Open;
if Circle102.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle103MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(26)+'"');
ADOQuery1.Open;
if Circle103.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle104MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(26)+'"');
ADOQuery1.Open;
if Circle104.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle105MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle105.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle106MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(27)+'"');
ADOQuery1.Open;
if Circle106.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle107MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(27)+'"');
ADOQuery1.Open;
if Circle107.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle108MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(27)+'"');
ADOQuery1.Open;
if Circle108.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle109MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle109.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle10MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle10.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle110MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(28)+'"');
ADOQuery1.Open;
if Circle110.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle111MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(28)+'"');
ADOQuery1.Open;
if Circle111.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle112MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(28)+'"');
ADOQuery1.Open;
if Circle112.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle113MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle113.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle114MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(29)+'"');
ADOQuery1.Open;
if Circle114.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle115MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(29)+'"');
ADOQuery1.Open;
if Circle115.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle116MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(29)+'"');
ADOQuery1.Open;
if Circle116.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle117MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle117.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle118MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(30)+'"');
ADOQuery1.Open;
if Circle118.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle119MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(30)+'"');
ADOQuery1.Open;
if Circle119.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle11MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(3)+'"');
ADOQuery1.Open;
if Circle11.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle120MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(30)+'"');
ADOQuery1.Open;
if Circle120.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle12MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(3)+'"');
ADOQuery1.Open;
if Circle12.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle13MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle13.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle14MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(4)+'"');
ADOQuery1.Open;
if Circle14.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle15MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(4)+'"');
ADOQuery1.Open;
if Circle15.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle16MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(4)+'"');
ADOQuery1.Open;
if Circle16.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle17MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle17.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle18MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
  ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(5)+'"');
ADOQuery1.Open;
if Circle18.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle19MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(5)+'"');
ADOQuery1.Open;
if Circle19.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle1MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle1.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle20MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(5)+'"');
ADOQuery1.Open;
if Circle20.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle21MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle21.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle22MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(6)+'"');
ADOQuery1.Open;
if Circle22.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle23MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(6)+'"');
ADOQuery1.Open;
if Circle23.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle24MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(6)+'"');
ADOQuery1.Open;
if Circle24.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle25MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle25.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle26MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(7)+'"');
ADOQuery1.Open;
if Circle26.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle27MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(7)+'"');
ADOQuery1.Open;
if Circle27.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle28MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(7)+'"');
ADOQuery1.Open;
if Circle28.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle29MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle29.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle2MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(1)+'"');
ADOQuery1.Open;
if Circle2.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle30MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(8)+'"');
ADOQuery1.Open;
if Circle30.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle31MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(8)+'"');
ADOQuery1.Open;
if Circle31.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle32MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(8)+'"');
ADOQuery1.Open;
if Circle32.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle33MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle33.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle34MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(9)+'"');
ADOQuery1.Open;
if Circle34.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle35MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(9)+'"');
ADOQuery1.Open;
if Circle35.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle36MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(9)+'"');
ADOQuery1.Open;
if Circle36.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle37MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle37.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle38MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(10)+'"');
ADOQuery1.Open;
if Circle38.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle39MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(10)+'"');
ADOQuery1.Open;
if Circle39.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle3MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(1)+'"');
ADOQuery1.Open;
if Circle3.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle40MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(10)+'"');
ADOQuery1.Open;
if Circle40.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle41MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle41.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle42MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(11)+'"');
ADOQuery1.Open;
if Circle42.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle43MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(11)+'"');
ADOQuery1.Open;
if Circle43.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle44MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(11)+'"');
ADOQuery1.Open;
if Circle44.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle45MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle45.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle46MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(12)+'"');
ADOQuery1.Open;
if Circle46.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle47MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(12)+'"');
ADOQuery1.Open;
if Circle47.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle48MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(12)+'"');
ADOQuery1.Open;
if Circle48.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle49MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle49.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle4MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(1)+'"');
ADOQuery1.Open;
if Circle4.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle50MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(13)+'"');
ADOQuery1.Open;
if Circle50.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle51MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(13)+'"');
ADOQuery1.Open;
if Circle51.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle52MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(13)+'"');
ADOQuery1.Open;
if Circle52.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle53MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle53.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle54MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(14)+'"');
ADOQuery1.Open;
if Circle54.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle55MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(14)+'"');
ADOQuery1.Open;
if Circle55.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle56MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(14)+'"');
ADOQuery1.Open;
if Circle56.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle57MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle57.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle58MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(15)+'"');
ADOQuery1.Open;
if Circle58.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle59MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(15)+'"');
ADOQuery1.Open;
if Circle59.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle5MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle5.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle60MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(15)+'"');
ADOQuery1.Open;
if Circle60.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle61MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle61.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle62MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(16)+'"');
ADOQuery1.Open;
if Circle62.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle63MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(16)+'"');
ADOQuery1.Open;
if Circle63.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle64MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(16)+'"');
ADOQuery1.Open;
if Circle64.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle65MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle65.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle66MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(17)+'"');
ADOQuery1.Open;
if Circle66.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle67MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(17)+'"');
ADOQuery1.Open;
if Circle67.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle68MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(17)+'"');
ADOQuery1.Open;
if Circle68.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle69MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle69.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle6Click(Sender: TObject);
begin
Circle6.Fill.Color:=TAlphaColorRec.Black;
end;

procedure TBlog1.Circle6MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(2)+'"');
ADOQuery1.Open;
if Circle6.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle70MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(18)+'"');
ADOQuery1.Open;
if Circle70.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle71MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(18)+'"');
ADOQuery1.Open;
if Circle71.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle72MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(18)+'"');
ADOQuery1.Open;
if Circle72.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle73MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle73.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle74MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(19)+'"');
ADOQuery1.Open;
if Circle74.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle75MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(19)+'"');
ADOQuery1.Open;
if Circle75.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle76MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(19)+'"');
ADOQuery1.Open;
if Circle76.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle77MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle77.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle78MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(20)+'"');
ADOQuery1.Open;
if Circle78.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle79MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(20)+'"');
ADOQuery1.Open;
if Circle79.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle7MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(2)+'"');
ADOQuery1.Open;
if Circle7.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle80MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(20)+'"');
ADOQuery1.Open;
if Circle80.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle81MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle81.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle82MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(21)+'"');
ADOQuery1.Open;
if Circle82.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle83MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(21)+'"');
ADOQuery1.Open;
if Circle83.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle84MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(21)+'"');
ADOQuery1.Open;
if Circle84.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle85MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle85.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle86MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(22)+'"');
ADOQuery1.Open;
if Circle86.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle87MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(22)+'"');
ADOQuery1.Open;
if Circle87.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle88MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(22)+'"');
ADOQuery1.Open;
if Circle88.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle89MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle89.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle8MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(2)+'"');
ADOQuery1.Open;
if Circle8.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle90MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(23)+'"');
ADOQuery1.Open;
if Circle90.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle91MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(23)+'"');
ADOQuery1.Open;
if Circle91.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle92MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(23)+'"');
ADOQuery1.Open;
if Circle92.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle93MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.Open;
if Circle93.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle94MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(24)+'"');
ADOQuery1.Open;
if Circle94.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle95MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(24)+'"');
ADOQuery1.Open;
if Circle95.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle96MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(24)+'"');
ADOQuery1.Open;
if Circle96.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle97MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(25)+'"');
ADOQuery1.Open;
if Circle97.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle98MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(25)+'"');
ADOQuery1.Open;
if Circle98.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle99MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(25)+'"');
ADOQuery1.Open;
if Circle99.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
...
procedure TBlog1.Circle9MouseDown(Sender: TObject; Button: TMouseButton;
  Shift: TShiftState; X, Y: Single);
begin
ADOQuery1.Close;
ADOQuery1.SQL.Clear;
...
ADOQuery1.SQL.Add('where N = "'+IntToStr(3)+'"');
ADOQuery1.Open;
if Circle9.StyleName=ADOQuery1.FieldValues['Javob'] then  s:=s+3.1;
